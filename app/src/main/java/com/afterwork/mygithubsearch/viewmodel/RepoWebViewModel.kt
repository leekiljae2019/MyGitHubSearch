...
class RepoWebViewModel(private val linkUrl: String) : BaseViewModel(){
    companion object{
        val TAG = "RepoWebViewModel"
    }
...
@BindingAdapter("repowebinit")
fun repoWebInit(view: WebView, vm : RepoWebViewModel){
